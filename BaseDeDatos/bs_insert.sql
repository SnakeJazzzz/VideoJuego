...
('Ice Sorceress', 250, 1, 30, 1, 8, 0, 1, 1),
('Stone Golem', 1250, 1, 150, 3, 1, 0, 1, 1),
('Troll', 650, 1, 120, 2, 1, 0, 1, 1),
('Scout', 200, 3, 50, 1, 2, 0, 1, 1),
('Cannon', 500, 0, 80, 2, 2, 1, 1, 1),
('Catapult', 400, 0, 120, 3, 3, 1, 1, 1),
('Mortar Tower', 450, 0, 100, 2.5, 4, 1, 1, 1),
('Archer Tower', 650, 0, 45, 1, 8, 1, 1, 1),
('Inferno Tower', 550, 0, 20, 2, 2, 1, 1, 1),
('Wizard Tower', 500, 0, 80, 1.5, 2, 1, 1, 1);
/*
