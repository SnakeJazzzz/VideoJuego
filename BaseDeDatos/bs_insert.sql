...
('Knight', 400, 1, 70, 1.5, 1, 0, 0, 1),
('Archer', 150, 1, 40, 0.8, 10, 0, 0, 1),
('Goblin', 50, 2, 35, 0.5, 1, 0, 0, 1),
('Giant', 1000, 1, 450, 2, 1, 0, 0, 1),
('Mage', 250, 1, 30, 1.5, 10, 0, 0, 1),
('Ghost', 200, 1, 55, 0.8, 1, 0, 0, 1),
('Orc', 350, 1.5, 65, 1, 1, 0, 0, 1),
('Assassin', 250, 2, 150, 0.5, 1, 0, 0, 1),
('Centaur', 450, 1, 100, 1.5, 2, 0, 0, 1),
('Elf', 200, 1.5, 70, 1.2, 15, 0, 0, 1),
('Berserker', 450, 1, 100, 0.8, 1, 0, 0, 1),
('Ice Sorceress', 250, 1, 30, 1, 8, 0, 0, 1),
('Stone Golem', 1250, 1, 150, 3, 1, 0, 0, 1),
('Troll', 650, 1, 120, 2, 1, 0, 0, 1),
('Scout', 200, 3, 50, 1, 2, 0, 0, 1),
...
('Elf', 'long-range attacks', 20, 3, 10),
