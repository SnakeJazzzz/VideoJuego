...
{
    public Image artworkImage; // Drag your Image component that displays the card artwork here in the inspector.
    public Card cardData; // The card data to display
    public Button button; // Button component is not necessary if you are assigning the onClick in the Inspector.
